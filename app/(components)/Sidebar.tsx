...
export default function Sidebar({ role }: { role: "instructor" | "student" }) {
      ...
      >
        {bottomLinks.map((link) => (
          <Link
            key={link.label}
            href={link.href}
            className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition text-gray-600 hover:bg-gray-100 ${
              collapsed ? "justify-center px-0" : ""
            }`}
          >
            <svg
        ...
        <button
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition text-gray-600 hover:bg-gray-100 mt-1 ${
            collapsed ? "justify-center px-0" : ""
          }`}
